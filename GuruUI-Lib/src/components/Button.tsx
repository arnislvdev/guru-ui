...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const base = 'inline-flex items-center justify-center rounded-[var(--arnis-radius,0.5rem)] font-medium transition-colors animate-[none] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--arnis-accent,#1e90ff)]/60 focus-visible:ring-offset-2 ring-offset-[color:var(--arnis-background,#121212)] disabled:opacity-60 disabled:cursor-not-allowed'
    ...
    const variants: Record<Variant, string> = {
      primary: 'bg-[color:var(--arnis-accent,#ffffff)] text-[color:var(--arnis-on-accent,#0b0b0b)] hover:bg-[color:var(--arnis-accent-hover,#e5e5e5)]',
      secondary: 'bg-white/10 text-[color:var(--arnis-heading,#ffffff)] hover:bg-white/20',
      ghost: 'bg-transparent text-[color:var(--arnis-body,#b3b3b3)] hover:bg-white/10',
      outline: 'border border-[color:var(--arnis-accent,#ffffff)]/20 text-[color:var(--arnis-accent,#ffffff)] hover:bg-[color:var(--arnis-accent,#ffffff)]/10',
